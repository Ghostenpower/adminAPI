<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="feedbackList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="用户建议" align="center" prop="suggestion" />
      <el-table-column label="联系方式" align="center" prop="contact" />
      <el-table-column label="图片地址" align="center" prop="imagesUrl" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="用户建议" prop="suggestion">
          <el-input v-model="form.suggestion" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="联系方式" prop="contact">
          <el-input v-model="form.contact" placeholder="请输入联系方式" />
        </el-form-item>
        <el-form-item label="图片地址" prop="imagesUrl">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        suggestion: [
          { required: true, message: "用户建议不能为空", trigger: "blur" }
        ],
        createTime: [
