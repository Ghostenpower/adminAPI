  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="店铺LOGO URL" prop="shopLogo">
        <el-input
          v-model="queryParams.shopLogo"
          placeholder="请输入店铺LOGO URL"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      ...
      <el-form-item label="商家类别" prop="category">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['system:merchants:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['system:merchants:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:merchants:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:merchants:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="merchantsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="店铺描述" align="center" prop="description" />
      <el-table-column label="商家类别" align="center" prop="category" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="店铺LOGO URL" prop="shopLogo">
          <el-input v-model="form.shopLogo" placeholder="请输入店铺LOGO URL" />
        </el-form-item>
        <el-form-item label="营业执照URL" prop="businessLicense">
        ...
        <el-form-item label="商家类别" prop="category">
          <el-input v-model="form.category" placeholder="请输入商家类别" />
        </el-form-item>
        <el-form-item label="创建时间" prop="createdAt">
          <el-date-picker clearable
...
<script>
import { listMerchants, getMerchants, delMerchants, addMerchants, updateMerchants } from "@/api/system/merchants"
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      listMerchants(this.queryParams).then(response => {
    ...
    handleUpdate(row) {
      ...
      getMerchants(merchantId).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除商家信息编号为"' + merchantIds + '"的数据项？').then(function() {
        return delMerchants(merchantIds)
      }).then(() => {
        this.getList()
    ...
    handleExport() {
      this.download('system/merchants/export', {
        ...this.queryParams
      }, `merchants_${new Date().getTime()}.xlsx`)
    }
  }
}
</script>
